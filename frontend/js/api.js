const API = {
    ...
    users: {
        ...
        async uploadAvatar(file) {
            return API.uploadFile('/users/me/avatar', file, 'avatar');
        },
        async search(query) {
    ...
    chats: {
        ...
        async kickMember(chatId, userId) {
            return API.request(`/chats/${chatId}/members/${userId}/kick`, {
                method: 'DELETE'
            });
        },
        async leave(chatId) {
        ...
        async delete(chatId) {
            return API.request(`/chats/${chatId}/delete`, { method: 'DELETE' });
        }
    },
    ...
    messages: {
        ...
        async uploadFile(file) {
            return API.uploadFile('/messages/upload', file, 'file');
        },
